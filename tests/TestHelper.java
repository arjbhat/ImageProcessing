...
public abstract class TestHelper {
  ...
  protected RGBColor[][] img1arr;
  protected Image img1;
  protected RGBColor[][] img2arr;
  protected Image img2;
  protected RGBColor c1;
  protected RGBColor c2;
  protected RGBColor c3;
  protected RGBColor c4;
  protected RGBColor c5;
  protected RGBColor c6;
  ...
  public void initImages() {
    ...
    img0 = new Image(new RGBColor[][]{}, 1);
    img1arr = new RGBColor[][]{{c1, c2}, {c3, c4}, {c5, c6}};
    img1 = new Image(img1arr, 127);
    img2arr = new RGBColor[][]{{c1, c2, c3}, {c4, c5, c6}};
  ...
  protected Image imageAsComponent(Image img, Function<RGBColor, Integer> component) {
    int height = img.getHeight();
    int width = img.getWidth();
    int maxValue = img.getMaxValue();
    RGBColor[][] grayColorArr = new RGBColor[height][width];
  ...
  protected Image imageBrightness(Image img, int num) {
    ...
    int width = img.getWidth();
    int maxValue = img.getMaxValue();
    RGBColor[][] colorArr = new RGBColor[height][width];
