...
/**
 * Tests for the controller pro max implementation.
 */
public class ImageProcessingControllerImplProMaxTest extends AbstractControllerTest {

  protected ImageProcessingController makeController(ImageProcessingModel model,
                                                     ImageProcessingView view,
                                                     Readable input) {
    return new ImageProcessingControllerImplProMax(model, view, input);
  }
  ...
  public void testControllerToModel() {
    UserIO[] interactions = new UserIO[]{
        ...
        inputs("downscale 1 1 img small-img"),
        prints("method: runCommand image-name: img dest-image-name: small-img"),
        inputs("red-component img mask red-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: red-img"),
        inputs("green-component img mask green-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: green-img"),
        inputs("blue-component img mask blue-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: blue-img"),
        inputs("value-component img mask value-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: value-img"),
        inputs("luma-component img mask luma-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: luma-img"),
        inputs("intensity-component img mask intensity-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: intensity-img"),
        inputs("horizontal-flip img mask horizontal-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: horizontal-img"),
        inputs("vertical-flip img mask vertical-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: vertical-img"),
        inputs("brighten 10 img mask brighten-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: brighten-img"),
        inputs("brighten -11 img mask brighten-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: brighten-img"),
        inputs("sepia img mask sepia-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: sepia-img"),
        inputs("greyscale img mask greyscale-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: greyscale-img"),
        inputs("sharpen img mask sharp-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: sharp-img"),
        inputs("blur img mask blur-img"),
        prints("method: getImage image-name: mask"),
        prints("method: runCommand image-name: img dest-image-name: blur-img"),
        inputs("size img"),
    ...
    assertTrue(macroLog.get(15) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Component(Color::getRed)),
        macroLog.get(15).execute(oneByOne));
    assertTrue(macroLog.get(16) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Component(Color::getGreen)),
        macroLog.get(16).execute(oneByOne));
    assertTrue(macroLog.get(17) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Component(Color::getBlue)),
        macroLog.get(17).execute(oneByOne));
    assertTrue(macroLog.get(18) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Component(Color::getValue)),
        macroLog.get(18).execute(oneByOne));
    assertTrue(macroLog.get(19) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Component(Color::getLuma)),
        macroLog.get(19).execute(oneByOne));
    assertTrue(macroLog.get(20) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Component(Color::getIntensity)),
        macroLog.get(20).execute(oneByOne));
    assertTrue(macroLog.get(21) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new HorizontalFlip()),
        macroLog.get(21).execute(oneByOne));
    assertTrue(macroLog.get(22) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new VerticalFlip()),
        macroLog.get(22).execute(oneByOne));
    assertTrue(macroLog.get(23) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Brighten(10)),
        macroLog.get(23).execute(oneByOne));
    assertTrue(macroLog.get(24) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Brighten(-11)),
        macroLog.get(24).execute(oneByOne));
    assertTrue(macroLog.get(25) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Sepia()),
        macroLog.get(25).execute(oneByOne));
    assertTrue(macroLog.get(26) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Greyscale()),
        macroLog.get(26).execute(oneByOne));
    assertTrue(macroLog.get(27) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Sharpen()),
        macroLog.get(27).execute(oneByOne));
    assertTrue(macroLog.get(28) instanceof Mask);
    assertEquals(this.imageMask(oneByOne, oneByOne, new Blur()),
        macroLog.get(28).execute(oneByOne));
  ...
  public void testControllerToView() {
    UserIO[] interactions = new UserIO[]{
        ...
        inputs("menu"),
        prints("method: renderMessage"), // 23 menu options
        prints("method: renderMessage"),
        prints("method: renderMessage"),
        prints("method: renderMessage"),
        prints("method: renderMessage"),
  ...
  public void testFileInput() {
    ...
    try (FileReader reader = new FileReader(testScript)) {
      new ImageProcessingControllerImplProMax(model, view, reader).control();
    } catch (IOException e) {
  ...
  private String[] printMenu() throws IllegalStateException {
    return new String[]{"Supported user instructions are: ",
        ...
        " ➤ horizontal-flip image-name mask-name dest-image-name "
            ...
            + "referred to henceforth by the given destination name)",
        " ➤ vertical-flip image-name mask-name dest-image-name "
        ...
        " ➤ blur image-name mask-name dest-image-name "
            ...
            + "referred to henceforth by the given destination name)",
        " ➤ sharpen image-name mask-name dest-image-name "
            + "(Partially sharpen an image to create a new image, "
            + "referred to henceforth by the given destination name)",
        " ➤ greyscale image-name mask-name dest-image-name "
            + "(Find the partially greyscale version of an image to create a new image, "
            + "referred to henceforth by the given destination name)",
        " ➤ sepia image-name mask-name dest-image-name "
